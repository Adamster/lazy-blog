...
namespace Lazy.Infrastructure.Migrations
{
    ...
    [Migration("20230118095212_AddedCommentsAndLikes")]
            ...
            modelBuilder.Entity("Lazy.Domain.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 1, 18, 11, 52, 12, 461, DateTimeKind.Unspecified).AddTicks(4093), new TimeSpan(0, 2, 0, 0, 0)),
                            Name = "System",
                            WebUrl = "system"
                        });
                });
