...
namespace Lazy.Presentation.Controllers
{
    ...
    public class AuthorController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IList<AuthorItemModel>>> Get()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<AuthorItemModel>> Get(Guid id)
        {
        ...
        [HttpPost]
        public async Task<CreatedAtActionResult> Post([FromBody] CreateAuthorModel createAuthorModel)
        {
            AuthorItemDto author = await _authorService.CreateAuthor(createAuthorModel.Adapt<CreateAuthorDto>());
